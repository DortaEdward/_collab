...
function HomeClosing() {
  return (
    <section className='home-closing-section'>
      ...
      <Link to='/register' className='closing-btn'>Try It Now</Link>
      <p className="closing-already-user">Already using _Collab? <Link to='/login' className='closing-login-redirect'>Log In</Link></p>
  </section>
  );
}
